        ...
        {props.quantity < 20 &&
          <div style={almostOutStyle}>
            <div style={itemStyle}>
              ...
              <a onClick={handleSellPintClick} className="waves-effect waves-light btn-small">Sell Pint</a> <a onClick={handleTapKegClick} className="waves-effect waves-light btn-small">Tap Keg</a>                
